...
{
    Rational temp;
    temp.numerator = std::abs(this->numerator);
...
bool Rational::operator>(Rational i)
{
    return this->numerator * i.denominator > i.numerator * this->denominator;
}
...
{
    Rational temp;
    temp.numerator = this->numerator * c.denominator;
    temp.denominator = this->denominator * c.numerator;
    temp.simplify();
    return temp;
}
